...
import org.jxch.capital.learning.train.booster.param.OptimalFutureSignalBoosterParam;
...
public class TrainDataOptimalFutureSignalBooster implements TrainDataSignalBooster {
    ...
    public PolicymakerChainParam apply(PolicymakerChainParam applyParam) {
        ...
        var boosterParam = chainParam.getServiceWrapper().getParamObj(OptimalFutureSignalBoosterParam.class);
    ...
    public Object getDefaultParam() {
        return new OptimalFutureSignalBoosterParam();
    }
